                ...
                <div class="d-flex justify-content-center">
                  <div class="col-md-10">
                    ...
                    <h1 class="pizzas text-center p-4">Add pizza</h1>
                      ...
                      @endif
                      <form action="pizzas" method="POST" class="row g-3 transboxaboutadd pizzas_form" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6 label_input">
                            <label for="pizza_name" class="form-label add_label_text">Pizza name</label>
                            <input value="{{ old('pizza_name') }}" type="text" class="form-control" id="pizza_name" name="pizza_name" placeholder="Add pizza name">
                        </div>
                        <div class="col-md-6 label_input">
                            <label for="pizza_ingredients" class="form-label add_label_text">Ingredients</label>
                            <textarea value="{{ old('pizza_ingredients') }}" class="form-control" id="pizza_ingredients" name="pizza_ingredients" rows="1" placeholder="Add pizza ingredients"></textarea>
                        </div>
                        <div class="col-md-6 mx-auto center label_input">
                            ...
                            <input value="{{ old('pizza_foto') }}" class="form-control" type="file" id="formFile" name="pizza_foto">
                        </div>
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end button_save">
                            <button type="submit" class="btn btn-success btn-lg">Save</button>                 
                            <a href="{{ url('/all_pizzas') }}" class="btn btn-success btn-lg">All pizza</a>
                        </div>
                      </form>
                    </div>           
                  </div>
