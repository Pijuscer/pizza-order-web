...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
      <nav class="colorNavbar navbar sticky-top navbar-expand-lg ">
        ...
        <main>
            <div class="container container_edit_attachments mt-4">
                <div class="d-flex justify-content-center">
                  <div class="col-md-10">
                    <a href="{{ url('/all_attachments') }}" class="btn btn-primary btn-lg atgal">Back</a>
                    <h1 class="edit_attachments text-center p-4">Edit attachments</h1>
                      @if ($errors->any())
                      ...
                      @endif
                      <form action="" method="POST" class="row g-3 transboxaboutadd attachments_edit_form">
                        @csrf
                          <div class="col-md-6 label_input">
                            <label for="attachment_name" class="form-label add_label_text">Attachment name</label>
                            <input value="{{ $attachments->attachment_name}}" type="text" class="form-control" placeholder="Attachment name" aria-label="attachment_name" id="attachment_name" name="attachment_name">
                          </div>
                          <div class="col-md-6 label_input">
                            <label for="attachment_price" class="form-label add_label_text">Attachment price</label>
                            <input value="{{ $attachments->attachment_price }}" type="text" class="form-control" placeholder="Attachment price" aria-label="attachment_price" id="attachment_price" name="attachment_price">
                          </div>
